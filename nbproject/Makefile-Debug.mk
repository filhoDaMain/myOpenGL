...
${OBJECTDIR}/src/vendor/imgui/imgui.o: src/vendor/imgui/imgui.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/include -Iinclude -Isrc/vendor -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vendor/imgui/imgui.o src/vendor/imgui/imgui.cpp

${OBJECTDIR}/src/vendor/imgui/imgui_demo.o: src/vendor/imgui/imgui_demo.cpp
	${MKDIR} -p ${OBJECTDIR}/src/vendor/imgui
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/include -Iinclude -Isrc/vendor -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vendor/imgui/imgui_demo.o src/vendor/imgui/imgui_demo.cpp

${OBJECTDIR}/src/vendor/imgui/imgui_draw.o: src/vendor/imgui/imgui_draw.cpp
	${MKDIR} -p ${OBJECTDIR}/src/vendor/imgui
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/include -Iinclude -Isrc/vendor -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vendor/imgui/imgui_draw.o src/vendor/imgui/imgui_draw.cpp

${OBJECTDIR}/src/vendor/imgui/imgui_impl_glfw.o: src/vendor/imgui/imgui_impl_glfw.cpp
	${MKDIR} -p ${OBJECTDIR}/src/vendor/imgui
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/include -Iinclude -Isrc/vendor -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vendor/imgui/imgui_impl_glfw.o src/vendor/imgui/imgui_impl_glfw.cpp

${OBJECTDIR}/src/vendor/imgui/imgui_impl_opengl3.o: src/vendor/imgui/imgui_impl_opengl3.cpp
	${MKDIR} -p ${OBJECTDIR}/src/vendor/imgui
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/include -Iinclude -Isrc/vendor -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vendor/imgui/imgui_impl_opengl3.o src/vendor/imgui/imgui_impl_opengl3.cpp

${OBJECTDIR}/src/vendor/imgui/imgui_widgets.o: src/vendor/imgui/imgui_widgets.cpp
	${MKDIR} -p ${OBJECTDIR}/src/vendor/imgui
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/include -Iinclude -Isrc/vendor -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vendor/imgui/imgui_widgets.o src/vendor/imgui/imgui_widgets.cpp
